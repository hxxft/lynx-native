...
namespace debug {
    ...
    public:
        explicit InspectorResponse(InspectorBasicInfo& info) : response_(info.GetInfoValue()) {
        ...
        std::string toString() {
            return response_.toStyledString();
        }
