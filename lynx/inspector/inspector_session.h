...
namespace debug {
    ...
    public:
        class Dispatcher {
        public:
            virtual void DispatchMessage(const base::ScopedRefPtr<base::IOBuffer>& data_buffer, uint64_t size) = 0;
        };
        ...
        void Dispatch(const base::ScopedRefPtr<base::IOBuffer>& data_buffer, uint64_t size);
    ...
    public:
        ...
        virtual void OnOpen(const base::ScopedRefPtr<base::IOBuffer>& data_buffer, uint64_t size);
        virtual void OnMessage(const base::ScopedRefPtr<base::IOBuffer>& data_buffer, uint64_t size);
