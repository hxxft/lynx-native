 ...
 public:
  ...
  inline static base::ScopedPtr<LynxValue> MakeBool(bool value) {
    base::ScopedPtr<LynxValue> lynx_value(
        lynx_new LynxValue(LynxValue::Type::VALUE_BOOL));
  ...
  inline static base::ScopedPtr<LynxValue> MakeLong(long value) {
    base::ScopedPtr<LynxValue> lynx_value(
        lynx_new LynxValue(LynxValue::Type::VALUE_LONG));
  ...
  inline static base::ScopedPtr<LynxValue> MakeInt(int value) {
    base::ScopedPtr<LynxValue> lynx_value(
        lynx_new LynxValue(LynxValue::Type::VALUE_INT));
  ...
  inline static base::ScopedPtr<LynxValue> MakeLynxFunction(
      LynxFunction* function) {
    base::ScopedPtr<LynxValue> lynx_value(
  ...
  inline static base::ScopedPtr<LynxValue> MakePlatformValue(
      PlatformValue* platform_value) {
    base::ScopedPtr<LynxValue> lynx_object(
  ...
  inline static base::ScopedPtr<LynxValue> MakeLynxHolder(
      LynxHolder* lynx_holder) {
    base::ScopedPtr<LynxValue> lynx_object(
  ...
  static base::ScopedPtr<LynxValue> MakeNull() {
    base::ScopedPtr<LynxValue> null(
        lynx_new LynxValue(LynxValue::Type::VALUE_NULL));
    return null;
  }
